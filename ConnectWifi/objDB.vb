...
Public Class objDB
    ''' <summary>
    ''' Ex. Connect(IPServer,Username,Password,NameApplication)
    ''' </summary>
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ConnectDB(ByVal strIp As String, ByVal strUser As String, ByVal strPass As String, ByVal NameApplication As String) As SqlConnection
        Dim conDb_form As String = "Server={0};UID={1};PASSWORD={2};Max Pool Size=4000;Connect Timeout=600;Trusted_Connection=False;Application Name=" & NameApplication
